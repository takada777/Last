var socket = io.connect("http://10.16.152.10:8081/homework_student", {
	'reconnection' : true,
...
function clickBtn(id,hw_id) {
	location.href = 'http://10.16.152.10:8080/g-learning/homework_question.jsp?name=' +  encodeURIComponent(id) + '?id=' +  encodeURIComponent(hw_id);
};
