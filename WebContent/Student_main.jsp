...
<html>
<head>
<jsp:useBean id="sab" class="learning.bean.StudentArrayBean"
	scope="session" />
...
<input type="hidden" id="user_id" value=<%=sb.getId()%>>
	<input type="hidden" id="user_name" value=<%=sb.getName()%>>
	<br>
	<br>
	<div
		class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom uk-background-muted">

		<div class="uk-text-center" uk-grid>
			<div class="uk-width-1-1">
				<div class="uk-background-muted uk-padding uk-panel">1-3</div>
			</div>
