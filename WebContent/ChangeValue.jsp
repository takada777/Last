...
<% if(val==1){ %>
	<form id="form" method="get" action="ChangeValueServlet">
<div class="select-area">
<h1 class="uk-heading-large tyuou">クラス変更</h1>
<br>
  	<br>
  	...
  	<div id=manaka>
  	<input type="submit" class="uk-button uk-button-default manaka" value="変更">
  	</div>
    </form>
<% }else if(val==2){ %>
	<form id="form" method="get" action="ChangeValueServlet">
	<div id=koikoi>
	<h1 class="uk-heading-large tyuou">名前変更</h1>
	<input type="text" placeholder="新しい名前を入力してください" size="40" name="val" class="validate[required] uk-input uk-form-width-large koikoi"/>
...
<% }else if(val==3){ %>
	<form id="form" method="get" action="ChangeValueServlet">
	<h1 class="uk-heading-large tyuou">メールアドレス変更</h1>
	<input type="text" placeholder="新しいメールアドレスを入力してください"  size="40" name="val" class="validate[required,custom[email]] uk-input uk-form-width-large koikoi"/>
...
<% }else if(val==4){ %>
	<form id="form" method="get" action="ChangeValueServlet">
	<h1 class="uk-heading-large tyuou">パスワード変更</h1>
	<input type="password" placeholder="新しいパスワードを入力してください"  size="40" name="val" id=student_pass class="validate[required] uk-input uk-form-width-large koikoi"/>
	<br>
	<input type="password" placeholder="新しいパスワードを再入力してください"  size="40" name="val" class="validate[required,equals[student_pass]] uk-input uk-form-width-large koikoi2"/>
...
function classselect(rows) {
	$("#classselect").html("");
	var test = '<select id="class" name="val" class="test9 validate[required] uk-form-width-large uk-select koikoi">'
